...
bot.action('beauty', (ctx) => {
  ...
  `;
  bot.telegram.sendMessage(ctx.chat.id, message, charactersMore);
...
Нежность губ твоих сравнива с сахарной ватой, при соприкосновении с которой, она начинает таять!
